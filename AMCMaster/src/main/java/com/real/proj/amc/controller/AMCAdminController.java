...
public class AMCAdminController {
  ...
  public ResponseEntity<List<Coupon>> getCoupon(Pageable pageable) {
    return new ResponseEntity<List<Coupon>>(this.crudService.findAll(Coupon.class, pageable), HttpStatus.OK);
  }
