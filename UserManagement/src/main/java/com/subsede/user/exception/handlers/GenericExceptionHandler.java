package com.subsede.user.exception.handlers;
...
import com.subsede.user.controllers.HTMLControllerMarker;
import com.subsede.user.controllers.rest.user.RestControllerMarker;
import com.subsede.user.exceptions.BindingFailureException;
...
import com.subsede.user.exceptions.UserNotFoundException;
import com.subsede.user.exceptions.VerificationTokenNotFoundException;
import com.subsede.user.model.error.BindingError;
