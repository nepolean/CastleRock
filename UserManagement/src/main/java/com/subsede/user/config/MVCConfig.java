...
import com.subsede.user.controllers.UserController;
import com.subsede.user.controllers.rest.user.UserRestController;
import com.subsede.user.eventListeners.RegistrationCompleteEventListener;
import com.subsede.user.exception.handlers.GenericExceptionHandler;
import com.subsede.user.services.mailer.MailerService;
