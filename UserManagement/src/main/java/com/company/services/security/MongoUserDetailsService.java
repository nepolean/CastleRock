package com.company.services.security;
...
public class MongoUserDetailsService implements UserDetailsService {
	...
	@Autowired
	private UserRepository<com.company.model.user.User> userRepository;
...
//		String ip = getClientIP();
		com.company.model.user.User user = getUserDetail(username);
	...
	public com.company.model.user.User getUserDetail(String username) {
		com.company.model.user.User user = userRepository.findByUsername(username);
		return user;
	}
